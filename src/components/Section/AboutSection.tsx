    ...
    return (
        <SectionLayout>
            ...
            <div className='flex flex-col gap-4 md:text-xl text-base text-justify font-sans'>
                ...
                <p>I&apos;m a Frontend Web Developer and Flutter Developer based in India. My expertise lies in JavaScript, ReactJS, and Flutter. Presently, I'm exploring Next.js and TypeScript to enhance my skill set and expand my development capabilities.</p>
