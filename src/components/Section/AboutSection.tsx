...
function About() {
    const aboutMe = [
        ...
        "I'm a Frontend Web and Flutter Developer based in India. My expertise lies in JavaScript, ReactJS, and Flutter. Presently, I'm exploring Next.js and TypeScript to enhance my skill set and expand my development capabilities.",
