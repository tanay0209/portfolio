...
export default function Home() {
	...
	const row1 = languages.slice(0, chunkSize);
	const row2 = languages.slice(chunkSize, chunkSize * 2);
	const row3 = languages.slice(chunkSize * 2);
	return (
		<>
			<Navbar />
			<SectionLayout classname='flex flex-col items-start space-y-8 w-full'>
				{/* HERO SECTION */}
				<h1 className='text-4xl pt-4 font-black font-bubblegum'>
					Konnichiwa! I&apos;m Tanay Jagnani
				</h1>
				<div className='flex flex-col space-y-4 text-justify'>
					<p>
						Welcome to my website! I am Tanay Jagnani, a software developer from
						India. I love converting ideas into products. I have worked with
						technologies like Reactjs, Nextjs, PostgreSQL, Nodejs etc
					</p>

					<p>
						Currently working as SDE1 at Credgenics, previously interned at 2 startups
						and TCS as system enegineer. I love to work in fast paced environment
						where I get to challenge myself.
					</p>

					<p>
						Currently I am working on{" "}
						<Link
							href='https://resourcifyy.xyz'
							className='text-cyan-400'
							target='_blank'
						>
							Resourcifyy
						</Link>{" "}
						<span className='text-sm'>(4000+ visits)</span> and{" "}
						<span className='text-cyan-400'>Smart Stock</span> (WIP)
					</p>
				...
				{/* SKILLS */}
				<h2 id='skills' className='text-4xl font-bold font-bubblegum'>
					What I Know!
          </h2>
          <div>
					<InfiniteMovingCards items={row1} />
					<InfiniteMovingCards items={languages.slice(10, 20)} direction='right' />
				...
				<div className='flex flex-col md:flex-row h-full gap-4'>
					<div className='space-y-8 justify-between h-full gap-4 w-full md:w-1/2'>
						<p className='text-justify'>
							I&apos;m open to new opportunities, collaborations and projects. Feel
							free to reach out to me on any of the platforms below.
						</p>
						<div className='flex gap-2 flex-col'>
							...
							<div className='flex items-center gap-2'>
								<File />{" "}
								<Link
									href='https://drive.google.com/drive/folders/1JAJkTCOukxwgJgKUsZ2XZSKJmwNnqFXp'
									target='_blanks'
								>
									Resume
								</Link>
						...
						<div className='flex flex-wrap gap-4'>
							...
							<Link
								target='_blank'
								href='https://www.instagram.com/__k.a.k.a.r.o.t.__'
							...
							<Link
								target='_blank'
								href='https://discord.com/users/479285563019493376'
				...
				{/* FOOTER */}
				<footer className='py-2 text-left font-bubblegum md:text-right text-lg text-lime-200'>
					{footerText}
				</footer>
			</SectionLayout>
		</>
